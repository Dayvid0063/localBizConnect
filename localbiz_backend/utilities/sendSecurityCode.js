...
<body style="background-color: #FFFFFF; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
	<table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #FFFFFF;">
		<tbody>
			<tr>
				<td>
					<table class="row row-1" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #4ecdc4;">
						<tbody>
							<tr>
								<td>
									<table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000000; background-color: #4ecdc4; width: 500px; margin: 0 auto;" width="500">
										<tbody>
											<tr>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 125px;"><img src="https://i.ibb.co/P1Zt9cp/swift-cart.png" style="display: block; height: auto; border: 0; width: 100%;" width="125" alt="your-logo" title="your-logo"></div>
																</div>
															</td>
														</tr>
													</table>
					...
					<table class="row row-2" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #4ecdc4;">
						<tbody>
							<tr>
								<td>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="column column-1" width="100%"
                                                                    ...
                                                                    <table class="paragraph_block block-3" width="100%" border="0" cellpadding="10" cellspacing="0"
                                                                        role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                                        <tr>
                                                                            <td class="pad">
                                                                                <div
                                                                                    ...
                                                                                    <p style="margin: 0;">Here is your one-time passcode (OTP): <strong>{{otp}}</strong>.
                                                                                        Please ignore this email if you did not make this request.</p>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
															...
															<td class="pad" style="text-align:center;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="center">
																	<table class="social-table" width="168px" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; display: inline-block;">
																		<tr>
																			<td style="padding:0 5px 0 5px;"><a href="https://www.facebook.com/phoenixhublr" target="_blank"><img src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/t-outline-circle-default-gray/facebook@2x.png" width="32" height="32" alt="Facebook" title="Facebook" style="display: block; height: auto; border: 0;"></a></td>
																			<td style="padding:0 5px 0 5px;"><a href="https://www.twitter.com/phoenixhublr" target="_blank"><img src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/t-outline-circle-default-gray/twitter@2x.png" width="32" height="32" alt="Twitter" title="Twitter" style="display: block; height: auto; border: 0;"></a></td>
																			<td style="padding:0 5px 0 5px;"><a href="https://www.instagram.com/phoenixhublr" target="_blank"><img src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/t-outline-circle-default-gray/instagram@2x.png" width="32" height="32" alt="Instagram" title="Instagram" style="display: block; height: auto; border: 0;"></a></td>
																			<td style="padding:0 5px 0 5px;"><a href="https://www.linkedin.com/phoenixhublr" target="_blank"><img src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/t-outline-circle-default-gray/linkedin@2x.png" width="32" height="32" alt="LinkedIn" title="LinkedIn" style="display: block; height: auto; border: 0;"></a></td>
																		</tr>
																	</table>
																</div>
															</td>
														...
														<tr>
															<td class="pad">
																<div style="color:#C0C0C0;font-family:Tahoma,Verdana,Segoe,sans-serif;font-size:12px;line-height:120%;text-align:center;mso-line-height-alt:14.399999999999999px;">
																	<p style="margin: 0; word-break: break-word;">Consumers (users) are advised to read the&nbsp;<a href="http://email.mg.jumia.com/c/eJwsjMFuwyAQRL9muUSJlgVi-8DBbeWeeuwHEJbYtAZaG1T17ytHPc1o5umx9QZx8IJddRa6J8DxdAKiHOpP2T6BCNR4DO-vR8cRuhcRrOzwOkijTC8Wq_nujAxGedMzDqjZG3m7onKkpWMS0RKSRkIihYPsL2zkYJD5Fu7XjqUBjWm-fLQU3cWXJFa71Pq1gxqBJqAp_f6fbQaaQj4_soYt7WeX-exL5lhjybvYrN_aXsIS8ha_W1CgcU4urg9xtc8lpZajdwd-eivc1vAXAAD__9llTvM" target="_blank" style="text-decoration: underline; color: #0068A5;" rel="noopener">Terms & Conditions</a>&nbsp;carefully.</p>
																	<p style="margin: 0;">Police Academy Road, Paynesville City, Liberia / phoenixhublr@gmail.com / (+231) 881158457<a href="http://www.example.com" style="text-decoration: underline; color: #0068A5;"></a></p>
																</div>
															</td>
														</tr>
													</table>
